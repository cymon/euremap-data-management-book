...
of artefact, not just DNA samples - data submitted to BioSamples must be in the
...
programmatically - [a guide can be found
here](https://read-docs-biosamples.readthedocs.io/en/latest/submit/programmatically.html).
...
For EUREMAP projects, we recommend you [use this
checklist](https://raw.githubusercontent.com/cymon/euremap-data-management-book/refs/heads/main/book/EUREMAP-Default-Sample-Checklist-ERC000011.tsv)
template that is based on the [ENA default sample checklist
(ERC000011)](https://www.ebi.ac.uk/ena/browser/view/ERC000011).  You can of
course add additional fields to the submission if necessary, but you should
